...
-- Reset Database: ลบตารางเก่าออกก่อนเพื่อป้องกัน Error "Table already exists"
...
-- 2.9 Payments (For fines or rental fees)
...
('รายการยืมคืน', 'borrowed_list.html', 1),
('จัดการระบบ', 'admin_control.html', 1);