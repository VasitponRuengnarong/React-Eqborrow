...
-- 2. TB_M_Department
INSERT INTO `TB_M_Department` (`DepartmentID`, `DepartmentName`, `InstitutionID`) VALUES 
(1, 'ไม่มีฝ่าย', 1),
(2, 'ฝ่ายเทคโนโลยีสารสนเทศ', 5),     -- สังกัด สำนักวิศวกรรม
(3, 'ฝ่ายบริหารความเสี่ยงและธรรมาภิบาล', 4), -- สังกัด สำนักบริหาร
(4, 'ฝ่ายยุทธศาสตร์องค์การ', 4),       -- สังกัด สำนักบริหาร
(5, 'ฝ่ายสนับสนุนคณะกรรมการและผู้บริหาร', 4), -- สังกัด สำนักบริหาร
(6, 'ศูนย์การเงิน', 4),                -- สังกัด สำนักบริหาร
(7, 'ศูนย์สื่อสารวาระทางสังคมและนโยบายสาธารณะ', 10), -- สังกัด สำนักเครือข่ายฯ
(8, 'ศูนย์ Thai PBS World', 9),        -- สังกัด สำนักข่าว
(9, 'ศูนย์วิจัยและพัฒนาสื่อสาธารณะ', 4),  -- สังกัด สำนักบริหาร (หรือวิศวกรรม)
(10, 'ศูนย์สื่อสารและส่งเสริมการตลาดเพื่อสาธารณะ', 4), -- สังกัด สำนักบริหาร
(11, 'ศูนย์พัฒนานวัตกรรมสื่อสาธารณะ', 2),  -- สังกัด สำนักสื่อดิจิทัล
(12, 'ศูนย์พัฒนาระบบงานสารสนเทศ', 5),    -- สังกัด สำนักวิศวกรรม
(13, 'ศูนย์สื่อสาธารณะเพื่อเด็กและการเรียนรู้', 8), -- สังกัด สำนักสร้างสรรค์เนื้อหา
(14, 'ศูนย์สื่อศิลปวัฒนธรรม', 8),         -- สังกัด สำนักสร้างสรรค์เนื้อหา
(15, 'หน่วยสนับสนุนสภาผู้ชมและผู้ฟังรายการ', 10); -- สังกัด สำนักเครือข่ายฯ
...
(1, 'IT Equipment'), (2, 'Camera'), (3, 'Audio'), (4, 'Lighting'), (5, 'Accessories');

-- 6. TB_M_Brand
INSERT INTO `TB_M_Brand` (`BrandID`, `BrandName`) VALUES 
(1, 'Sony'), (2, 'Canon'), (3, 'Panasonic'), (4, 'Apple'), (5, 'Dell'), (6, 'Shure'), (7, 'Sennheiser'), (8, 'Manfrotto');

-- 7. TB_M_Type
INSERT INTO `TB_M_Type` (`TypeID`, `TypeName`) VALUES 
(1, 'Laptop'), (2, 'Desktop'), (3, 'Video Camera'), (4, 'DSLR/Mirrorless'), (5, 'Lens'), (6, 'Microphone'), (7, 'Tripod'), (8, 'Light Kit');

-- 8. TB_M_Model
INSERT INTO `TB_M_Model` (`ModelID`, `ModelName`) VALUES 
(1, 'MacBook Pro 16'), (2, 'Dell Latitude 7420'), (3, 'Sony A7S III'), (4, 'Canon EOS R5'), (5, 'Sennheiser EW 100 G4'), (6, 'Manfrotto 504X'), (7, 'Panasonic Lumix GH6'), (8, 'Shure SM7B');
...
INSERT INTO `TB_T_Device` (`devicename`, `CategoryID`, `BrandID`, `ModelID`, `DVStatusID`, `serialnumber`, `stickerid`, `TypeID`, `CreateBy`, `Brand`, `DeviceType`) VALUES 
('Sony Alpha A7S III', 2, 1, 3, 1, 'SN12345678', 'EQ-CAM-001', 4, 'System Admin', 'Sony', 'DSLR/Mirrorless'),
('Canon EOS R5', 2, 2, 4, 1, 'SN87654321', 'EQ-CAM-002', 4, 'System Admin', 'Canon', 'DSLR/Mirrorless'),
('MacBook Pro 16 M1', 1, 4, 1, 2, 'C02XXXXX', 'EQ-NB-001', 1, 'System Admin', 'Apple', 'Laptop'),
('Sennheiser EW 100 G4', 3, 7, 5, 1, 'SN112233', 'EQ-AUD-001', 6, 'System Admin', 'Sennheiser', 'Microphone'),
('Dell Latitude 7420', 1, 5, 2, 1, 'DL123456', 'EQ-NB-002', 1, 'System Admin', 'Dell', 'Laptop'),
('Manfrotto 504X Tripod', 5, 8, 6, 1, 'MN504X001', 'EQ-ACC-001', 7, 'System Admin', 'Manfrotto', 'Tripod'),
('Panasonic Lumix GH6', 2, 3, 7, 3, 'PN987654', 'EQ-CAM-003', 4, 'System Admin', 'Panasonic', 'DSLR/Mirrorless'),
('Shure SM7B', 3, 6, 8, 1, 'SH778899', 'EQ-AUD-002', 6, 'System Admin', 'Shure', 'Microphone');

-- 14. TB_M_Product (ข้อมูลสินค้าตัวอย่าง - ถ้ามีการใช้งานตารางนี้)
INSERT INTO `TB_M_Product` (`ProductName`, `ProductCode`, `Price`, `Quantity`, `Description`, `TotalQuantity`) VALUES 
('MacBook Pro 16 M1', 'P-IT-001', 89900.00, 5, 'High performance laptop for video editing', 5),
('Sony Alpha A7S III', 'P-CAM-001', 120000.00, 3, 'Full-frame mirrorless camera for video', 3),
('Sennheiser EW 100 G4', 'P-AUD-001', 25000.00, 10, 'Wireless microphone system', 10),
('Dell Latitude 7420', 'P-IT-002', 45000.00, 8, 'Business laptop for general use', 8),
('Canon EOS R5', 'P-CAM-002', 130000.00, 2, 'High resolution camera', 2),
('Manfrotto 504X', 'P-ACC-001', 15000.00, 4, 'Professional video tripod head', 4);

-- 15. TB_T_Employee (ข้อมูลพนักงานตัวอย่างสำหรับ Dashboard)
INSERT INTO `TB_T_Employee` (`fname`, `lname`, `username`, `password`, `email`, `RoleID`, `EMPStatusID`, `InstitutionID`, `DepartmentID`) VALUES 
('System', 'Admin', 'admin', '$2a$10$YourHashedPasswordHere', 'admin@system.com', 1, 1, 1, 1);

-- 16. TB_T_Borrow (ข้อมูลการยืมตัวอย่าง)
INSERT INTO `TB_T_Borrow` (`EMPID`, `BorrowDate`, `ReturnDate`, `Purpose`, `Status`, `CreatedDate`) VALUES
(1, CURDATE(), DATE_ADD(CURDATE(), INTERVAL 3 DAY), 'ถ่ายทำรายการข่าว', 'Pending', NOW()),
(1, DATE_SUB(CURDATE(), INTERVAL 5 DAY), DATE_SUB(CURDATE(), INTERVAL 2 DAY), 'บันทึกภาพกิจกรรม', 'Returned', DATE_SUB(NOW(), INTERVAL 5 DAY)),
(1, DATE_SUB(CURDATE(), INTERVAL 10 DAY), DATE_SUB(CURDATE(), INTERVAL 7 DAY), 'ใช้งานนอกสถานที่', 'Approved', DATE_SUB(NOW(), INTERVAL 10 DAY));

-- 17. TB_T_BorrowDetail (รายละเอียดการยืมตัวอย่าง)
INSERT INTO `TB_T_BorrowDetail` (`BorrowID`, `ItemName`, `Quantity`, `Remark`) VALUES
(1, 'Sony Alpha A7S III', 1, ''),
(1, 'Sennheiser EW 100 G4', 2, ''),
(2, 'Canon EOS R5', 1, ''),
(3, 'Dell Latitude 7420', 1, '');

-- 18. TB_L_ActivityLog (ข้อมูล Log ตัวอย่าง)
INSERT INTO `TB_L_ActivityLog` (`ActionType`, `BorrowID`, `ActorID`, `Details`) VALUES
('Approved', 3, 1, 'Admin approved request');
